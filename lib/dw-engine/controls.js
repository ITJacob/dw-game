...
export class DWKeyboard {
  ...
  init(camera, param) {
    ...
    this.camera.update = function() {
      ...
      if (that.moveForward)  theCamera.position.z -= that.moveSpeed;
      if (that.moveBackward) theCamera.position.z += that.moveSpeed;
      if (that.moveLeft)     theCamera.position.x -= that.moveSpeed;
      if (that.moveRight)    theCamera.position.x += that.moveSpeed;
